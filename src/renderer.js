...
function renderDownloads(){$('#content').innerHTML=`<section class="page">${pageHeader('YOUR DOWNLOAD HUB','ดาวน์โหลด','เลือกตำแหน่งบันทึกก่อนดาวน์โหลด · รายการที่เสร็จในโหมดปกติจะอยู่ในเครื่องข้ามการเปิดแอป')}${downloadRows()}</section>`;}
